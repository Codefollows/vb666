...
//only called now from the legacy data object code in this directory.
//I don't think the code that calls it is used by the upgrader at all but untangling that
//isn't an easy task.  For now just leave it here.
