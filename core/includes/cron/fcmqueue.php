...
$conditions = [
	['field' => 'removeafter', 'value' => $cutoff, 'operator' => vB_dB_Query::OPERATOR_LTE],
];
$offloadHashes = $assertor->assertQuery('vBForum:fcmessage_offload', [
	vB_dB_Query::CONDITIONS_KEY => $conditions,
	vB_dB_Query::COLUMNS_KEY => ['hash'],
]);
/*
...
{
	log_cron_action(serialize([$processedCount, $deletedCount]), $nextitem, 1);
}

/*=========================================================================*\
|| #######################################################################
|| # Downloaded: 06:53, Sun Oct 27th 2024
|| # CVS: $RCSfile$ - $Revision: 107851 $
|| #######################################################################
\*=========================================================================*/
