...
define('CVS_REVISION', '$RCSfile$ - $Revision: 115347 $');
...
if ($_REQUEST['do'] == 'add' OR $_REQUEST['do'] == 'edit')
{
	...
	[$colorpickercss, $colorpickerhtml] = explode('</style>', $colorpickerhtml);
...
if ($_POST['do'] == 'savepermissions')
{
	...
	print_stop_message2('saved_event_highlight_permissions', 'eventhighlight', ['do' => 'list']);
}
...
if ($_POST['do'] == 'kill')
{
	...
	print_stop_message2('eventhighlight_deleted', 'eventhighlight', ['do' => 'list']);
}
...
if ($_POST['do'] == 'insert')
{
	...
	print_stop_message2('event_highlight_saved', 'eventhighlight', ['do' => 'list']);
}
...
if ($_REQUEST['do'] == 'add' OR $_REQUEST['do'] == 'edit')
{
	...
	if ($eventhighlight['eventhighlightid'])
	{
...
if ($_POST['do'] == 'displayorder')
{
	...
	print_stop_message2('saved_display_order_successfully', 'eventhighlight', ['do' => 'list']);
}
...
if ($_REQUEST['do'] == 'list')
{
	...
	$eventhighlights = $eventHighlightApi->getEventHighlightsAdmin([], true);
	...
	{
		$cells = [$vbphrase['event_highlight'], $vbphrase['event_highlight_permissions'], $vbphrase['display_order'], $vbphrase['controls']];
