  ...
  function triggerCondense(control, opts){
    ...
    orig.animate({height:con_h, width:con_w, opacity: 1}, opts.lessSpeed, opts.easing,
      function(){
        ...
        condensed.show();
        if (typeof opts.onCondense == 'function'){
          opts.onCondense.apply(control, [condensed]);
        }
        if (typeof opts.onToggle == 'function'){
          opts.onToggle.apply(control, [orig, condensed, true]);
    	}
      });
  }
    ...
    orig.animate({height:orig_h, width:orig_w, opacity: 1}, opts.moreSpeed, opts.easing,
      function(){
    	if (typeof opts.onExpand == 'function'){
    	  opts.onExpand.apply(control, [orig]);
    	}
    	if (typeof opts.onToggle == 'function'){
    	  opts.onToggle.apply(control, [orig, condensed, false]);
      	}
      });
