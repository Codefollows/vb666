...
;PLUGINS.viewport = function(api, position, posOptions, targetWidth, targetHeight, elemWidth, elemHeight)
{
	...
	var viewportIsWindow = (viewport[0] === window);
	fixed = tooltip.css('position') === 'fixed';
	viewportWidth = viewportIsWindow ? viewport.width() : viewport.outerWidth(FALSE);
	viewportHeight = viewportIsWindow ? viewport.height() : viewport.outerHeight(FALSE);
	viewportScroll = { left: fixed ? 0 : viewport.scrollLeft(), top: fixed ? 0 : viewport.scrollTop() };
	viewportOffset = (!viewportIsWindow && viewport.offset()) || adjusted;
