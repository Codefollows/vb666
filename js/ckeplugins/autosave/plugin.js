...
CKEDITOR.plugins.add('autosave', {
	...
	editorReady: function(event)
	{
		...
		{
			editor.vBulletin.autosave.autoLoadText = editor.vBulletin.autosave.$parentform.find('span.ckeditor-auto-load').text();
			// Restore Link
	...
	commands : {
		...
		saveData: function (editor, parentid, nodeid, pagetext)
		{
			...
			vBulletin.AJAX(
			{
				...
				error: vBulletin.ajaxtools.logAjaxError,
				beforeSend: () =>
				{
