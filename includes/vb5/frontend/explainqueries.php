...
/*
//this is moved ot the back end now to save memory/avoid holding open object references for the entire script run
//commenting out to avoid confusion over where this is happening.
